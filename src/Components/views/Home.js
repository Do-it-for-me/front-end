    ...
    <StyledHome>
      ...
      <div className="infoSection">
        ...
        <div className="infoItem">
          ...
          <p className="text2">
            Find a trusted service provider to help you take care of your home
            or pets while you are away or help you do something at home{" "}
          </p>
        </div>
        <div className="infoItem">
          <img src={image7} alt="image7" className="image7" width="200px" />
          <p>
            Both parties can benefit from this deal, one provides time and
